              ...
              <tr>
                <td className="px-6 py-4">
                  <div className="flex flex-row gap-4 items-center">
                    ...
                    <span className="font-semibold text-sm">Bob Johnson</span>
                  </div>
                </td>
                <td className="px-6 py-4 text-sm">bob@example.com</td>
                <td className="px-6 py-4 text-sm">
                  <span className="bg-blue-800 font-semibold text-blue-100 rounded-full px-2 text-xs">
                    Customer
                  </span>
                ...
                <td className="px-6 py-4">
                  <span className="bg-red-800 font-semibold text-red-100 rounded-full px-2 text-xs">
                    Inactive
                  </span>
                </td>
                <td className="px-6 py-4 text-sm">
              ...
              <tr>
                <td className="px-6 py-4">
                  <div className="flex flex-row gap-4 items-center">
                    ...
                    <span className="font-semibold text-sm">Alice Brown</span>
                  </div>
                </td>
