...
interface Props {
    ...
    newUsers: string;
    totalProductsTitle: string;
    totalProducts: string;
    ConversionRateTitle: string;
    ConversionRate: String;
}
const HeaderPanel: React.FC<Props> = ({
    totalSalesTitle, totalSales,
    newUsersTitle, newUsers,
    totalProductsTitle, totalProducts,
    ConversionRateTitle, ConversionRate
    ...
    return (
        <div className='grid grid-cols-4 gap-3 pb-8'>
            ...
            <div
                className='newUsers bg-menuBody p-5 rounded-lg border-bmenuBody border-[1px] border-solid hover:shadow-itemMenuOverview hover:translate-y-[-5px]'>
                <div className='flex items-center font-medium text-gray-400 text-sm'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            fill-rule="evenodd"
            ...
            <div className='totalProducts bg-menuBody p-5 rounded-lg border-bmenuBody border-[1px] border-solid hover:shadow-itemMenuOverview hover:translate-y-[-5px]'>
                <div className='flex items-center font-medium text-gray-400 text-sm'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='conversionRate bg-menuBody p-5 rounded-lg border-bmenuBody border-[1px] border-solid hover:shadow-itemMenuOverview hover:translate-y-[-5px]'>
                <div className='flex items-center font-medium text-gray-400 text-sm'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            fill-rule="evenodd"
